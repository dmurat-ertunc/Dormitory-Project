...
public class StudentRequestRentalDTO {
    private Long id;
    ...
    public StudentRequestRentalDTO(Long id, Long sportAreaId, String sporType, LocalDate rentalDate, LocalTime startTime,
                                   LocalTime endTime, Long studentId, LocalDate studentBirthDate, String studentMail,
                                   String studentName, String studentSurName, String studentTcNo, boolean studentVerify,
                                   String details) {
        this.id = id;
    ...
    public StudentRequestRentalDTO(){
