...
class DBQSoapFaultEx extends org.ksoap2.SoapFault
{
    public Object fault;
}
...
public class DBQExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(DBQDateTimeConverter converter)
    {
        if(converter==null)
        {
            converter = new DBQStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static DBQDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static DBQDateTimeConverter dateTimeConverter = new DBQStandardDateTimeConverter();

    public DBQExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public DBQExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new DBQMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=DBQHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,DBQExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=DBQHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
