...
public class DBQKPSPublicSoap12
{
    ...
    public DBQKPSPublicSoap12(){}

    public DBQKPSPublicSoap12(String url)
    {
        this.url = url;
    }

    public DBQKPSPublicSoap12(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        DBQExtendedSoapSerializationEnvelope envelope= new DBQExtendedSoapSerializationEnvelope(DBQExtendedSoapSerializationEnvelope.VER12);
